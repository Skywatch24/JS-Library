  ...
  (0, _react.useEffect)(() => {
    const initPlayer = async () => {
      ...
      if (res.data && containerRef.current) {
        ...
        const player = (0, _video.default)(videoEl, _objectSpread(_objectSpread(_objectSpread({}, defaultPlayerOptions), playerOptions), {}, {
          sources: [{
            src: res.data
          }]
        }));
        player.currentTime(seek);
        onPlayerInit && onPlayerInit(player); // // for debug purpose
