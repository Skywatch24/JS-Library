...
import {STATUS_OK, STATUS_END, STATUS_HOLE, STREAM_TYPE} from './Constants';
...
const VIDEO_STYLE = {height: VIDEO_SIZE.height, width: VIDEO_SIZE.width};
...
const CameraView = forwardRef(
  ({deviceId, streamType, renderLoading, controls}, ref) => {
    ...
    const [liveCounter, setLiveCounter] = useState(0); // use counter as key for <FlvPlayer /> or <HlsPlayer />
    ...
    const onChangeTimeAndScale = function(
      scale,
      new_left_time,
      new_right_time,
    ) {
